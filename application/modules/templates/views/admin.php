	...
	<div class="navbar">
		<div class="navbar-inner">
			...
			<!-- <a href=""><button class="btn btn-primary">Update Item Categorie</button></a> -->
				<a class="brand" href="<?php echo base_url(); ?>stor_items/manage"><span>CI SHOP</span></a>
	...
	<!-- start: Header -->
		...
		<div class="container-fluid-full">
			<div class="row-fluid">
				...
				<div id="sidebar-left" class="span2">
					<div class="nav-collapse sidebar-nav">
						<ul class="nav nav-tabs nav-stacked main-menu">
							...
							<li><a href="<?=base_url() ?>stor_items/manage"><i class="icon-tag"></i><span class="hidden-tag">Manage Items</span></a></li>	
						<li><a href="<?=base_url() ?>stor_account/manage"><i class="icon-briefcase"></i><span class="hidden-tablet"> Account</span></a></li>	
						<li><a href="<?=base_url() ?>stor_category/manage"><i class="icon-align-justify"></i><span class="hidden-tablet"> Categories</span></a></li>	
				...
				<?php  
	                if(isset($view_file)){
	                	$this->load->view($stor_items.'/'.$view_file);
	                }
